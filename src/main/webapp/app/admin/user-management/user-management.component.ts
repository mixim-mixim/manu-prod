...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-manufacturerproductapplicationapp-alert'], {
          param: decodeURIComponent(res.headers['x-manufacturerproductapplicationapp-params'].replace(/\+/g, ' ')),
        });
